...
Download the installer for your OS from [Releases](https://github.com/H8db0y/m4tr1x-electron/releases/latest), verify the SHA-256 against `checksums-*.txt`, and run.
