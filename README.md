...
Download the binary for your OS from [Releases](https://github.com/H8db0y/m4tr1x-electron/releases/latest) and run it. Verify the SHA-256 against `checksums-*.txt` before running.
