...
git remote set-url origin "https://$token@github.com/H8db0y/m4tr1x-electron.git"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "https://github.com/H8db0y/m4tr1x-electron" -ForegroundColor Cyan
} else {
    Write-Host ""
...
git remote set-url origin "https://github.com/H8db0y/m4tr1x-electron.git"
